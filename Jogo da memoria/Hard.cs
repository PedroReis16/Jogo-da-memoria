...
namespace Jogo_da_memoria
{
    public partial class Hard : Form
    {
        ...
        private void label_Click(object sender, EventArgs e)
        {
            ...
            Tentativas.Text = tentativas.ToString();
        ...
        private void Vencedor()
        {
            ...
            if (MessageBox.Show($"Congratulations! You won the game in {30 - tempo} and with {20 - tentativas} attemps") == DialogResult.OK)
            {
        ...
        {
            tempo--;
            TempoSegundos.Text = tempo.ToString();
